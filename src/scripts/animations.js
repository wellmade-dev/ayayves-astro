...
export function initMarquee(marqueeObject, speedInteger) {
	if (!marqueeObject) return null;

	function setupMarquee(marquee, speed) {
	...
	setupMarquee(marqueeObject, speedInteger);
